...
Since our data now has panel attributes, the entity and time variables will be automatically used as panel identifiers or grouping variables. Alternatively, one can explicitly specify `index` or `group` argument of each function.
